...
from .MPO_ImprovementStrategy import *
import contextlib
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            DWConvTranspose2d, C3x, RepC3, RepConv,
                 SAConv2d, C2f_SAConv, nn.Conv2d, SPPELAN,  DynamicConv, C2fCIB,
                 PSA, SCDown
        }:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3,  C2f_SAConv, C2fCIB}:
